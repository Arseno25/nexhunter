...
_CATEGORY_KEYWORDS = (
    ...
    ("crypto", ("hashid", "hashcat", "john", "openssl", "testssl", "sslscan", "sslyze", "cipher")),
    ...
    (
        "exploitation",
        ("metasploit", "msf", "empire", "cobalt", "havoc", "sliver", "exploit", "hydra", "medusa", "ncrack", "patator"),
    ),
...
_tool_specs = {
    ...
    "msfvenom": ToolSpec(
        ...
        params={"payload": "windows/meterpreter/reverse_tcp"},
        timeout=30,
